...
![](https://cdn.jsdelivr.net/gh/Dora-Honor/image-hosting/images/250727/1.png)  
![](https://cdn.jsdelivr.net/gh/Dora-Honor/image-hosting/images/250727/2.png)

经过排查和日志信息，发现是 `wofadk.sys` 驱动的版本太高而未能正常加载。将其替换成 10.0.14393.x 及以下版本即可解决。

![](https://cdn.jsdelivr.net/gh/Dora-Honor/image-hosting/images/250727/3.png)  
![](https://cdn.jsdelivr.net/gh/Dora-Honor/image-hosting/images/250727/4.png)